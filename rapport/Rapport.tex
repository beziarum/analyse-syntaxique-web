...
La premiere partie étant bien maitrisé nous nous somme lancé dans l'enrichissement
de la gestion de la syntaxe du language

\subsection{Les variables}

Les variables n'étais pas la partie la plus dure a gérer du point de vus de
la grammaire. Nous avons décidé de gérer indépendament les variables qui commence
en début de fichier comme une suite de déclaration et les variable local.
Nous avons définit quelque token suplémentaire, ajouter quelque régle a la
grammaire et le résultat a vite était satisfaisant.
\newline
Mais la gestion de ces variable au sein des structure fut plus compliqué.
En effet nous avençon a taton quand au fonctionnement de la machine virtuel. Et
nous mettons du temps a chaque nouvelle action qu'il faut effectuer sur ces
derniere.
